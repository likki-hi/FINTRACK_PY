...
FINTRACK PY provides a simple command-line solution for recording financial transactions and generating useful financial summaries.
...
Transaction data is stored in `data.json` and loaded when the application starts.
...
```text
test_balance ... ok
test_category_spending ... ok
test_largest_expense ... ok
test_total_expenses ... ok
test_total_income ... ok
...
Screenshots demonstrating the application interface are stored in the `screenshots/` folder.
...
Python | Data Analytics | SQL | Power BI | Generative AI
